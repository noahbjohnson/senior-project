...
# Subject Datasets
General = pd.read_csv("../data/production/subject/General.csv").set_index(["Country Code","Year"])
Labor = pd.read_csv("../data/production/subject/Labor.csv").set_index(["Country Code","Year"])
Urbanization = pd.read_csv("../data/production/subject/Urbanization.csv").set_index(["Country Code","Year"])
Education = pd.read_csv("../data/production/subject/Education.csv").set_index(["Country Code","Year"])
Inequality = pd.read_csv("../data/production/subject/Inequality.csv").set_index(["Country Code","Year"])
Economic = pd.read_csv("../data/production/subject/Economic.csv")
